                ...
                <Container>
                    <Row className='rounded shadow'>
                        <Col md={3} className='mt-5'>
                            <img  src="https://i0.wp.com/www.agencyreporter.com/wp-content/uploads/2019/09/baby-care-industry.jpg?fit=592%2C509&ssl=1"  alt="serviceprovider1" style={{ height: '700px', width: '100%' }} />
                        </Col>
                        ...
                        <Col md={3} className='mt-5'>
                            <img className=' mb-3' src="https://dailynclexchallenge.com/static/img/blog/nurse-with-pregnant.png" alt="serviceprovider2" style={{ height: '700px', width: '100%' }} />
                        </Col>
                    </Row>
                </Container>
            </div>
